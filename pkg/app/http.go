...
type Handler struct {
	...
	// issues with go-pwa functionality.
...
func (h *Handler) initIcon() {
	if h.Icon.Default == "" {
		h.Icon.Default = "https://raw.githubusercontent.com/maxence-charriere/go-pwa/master/docs/web/icon.png"
		h.Icon.Large = "https://raw.githubusercontent.com/maxence-charriere/go-pwa/master/docs/web/icon.png"
	}
	...
	if h.Icon.SVG == "" {
		h.Icon.SVG = "https://raw.githubusercontent.com/maxence-charriere/go-pwa/master/docs/web/icon.svg"
	}
}
...
func (h *Handler) serveLibrary(w http.ResponseWriter, library []byte) {
