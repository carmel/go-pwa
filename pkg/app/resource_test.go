...
func TestClientResourceResolver(t *testing.T) {
	utests := []struct {
		...
		},
		{
			...
			staticResourcesURL: "https://storage.googleapis.com/go-pwa/web",
			path:               "/hello",
			expected:           "/hello",
		},
		{
		...
		},
		{
			...
			staticResourcesURL: "https://storage.googleapis.com/go-pwa/web",
			path:               "/web/hello.css",
			expected:           "https://storage.googleapis.com/go-pwa/web/hello.css",
		},
		{
		...
		},
		{
			...
			path:     "https://storage.googleapis.com/go-pwa/web/hello.css",
			expected: "https://storage.googleapis.com/go-pwa/web/hello.css",
		},
		{
