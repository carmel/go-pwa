...
build:
	@echo "\033[94m• Building go-pwa documentation PWA\033[00m"
	@godoc -url /pkg/github.com/carmel/go-pwa/pkg/app > ./docs/web/documents/reference.html
	@GOARCH=wasm GOOS=js go build -v -o docs/web/app.wasm ./docs/src
	@echo "\033[94m• Building go-pwa documentation\033[00m"
	@go build -o docs/documentation ./docs/src

run: build
	@echo "\033[94m• Running go-pwa documentation server\033[00m"
