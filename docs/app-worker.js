...
const resourcesToCache = [
  ...
  "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1013306768105236",
];
...
self.addEventListener("activate", (event) => {
  ...
  console.log(
    "app worker 8a5b8e9e77360856e3666adbdd05a1a9e4e08803 is activated"
  );
});
